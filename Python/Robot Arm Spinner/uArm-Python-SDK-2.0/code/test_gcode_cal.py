...
ArduinoSerial = serial.Serial('COM4',2400) #COM3 is the port of Dispensing unit
time.sleep(2) 
...
gcode_file = r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\Letter_P_15_15_1mm-80R-0_5s.txt" # import gcode file
...
a_gcode, b_gcode = calibration(Z0, a_gcode, b_gcode, r_stage) # Perform calibration
