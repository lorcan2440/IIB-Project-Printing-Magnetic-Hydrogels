# -*- coding: utf-8 -*-
"""
Created on Wed Mar 30 12:56:33 2022
...
#write straight line points, wrt our coordinate system
straightline_x = [0, 25]
straightline_y = [0, 0]

#populate the 2D arrays that stores the positions that the arm needs to move to during printing
a_printpath = straightline_y #x positions in arm coord system
b_printpath = straightline_x #y positions in arm coord system
...
#move z position to 1.5mm above glass slide
z_calibrated -= 1.5

print('original print path', xy_printpath)
...
print('calibrated print path', xy_printpath)
