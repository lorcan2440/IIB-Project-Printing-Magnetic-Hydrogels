...
Z0 = 65 # starting z position
offset = [0, 0.5, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
printhead = 3
stage = 1 #1 Small, 2 Large


bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Yaqi\box.txt", offset) # Import gcode
...
spp = 15  # Printing speed
spnp = 1000  # Not printing speed 
Z0 = 66.45 # starting z position
offset = [1, -1.5, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
printhead = 2
stage = 1 #1 Small, 2 Large


bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Yaqi\ssbox.txt", offset) # Import gcode
