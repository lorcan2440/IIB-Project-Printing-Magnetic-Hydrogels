...
# Load Gcode
spp = 60 # Printing speed 15
spnp = 2000  # Not printing speed64
Z0 = 71.4# starting z position 72 3ml 74.5 44
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
printhead = 3
stage = 2 #1 Small, 2 Large

#blood_vessel_cut_20mm_60R_0_4s
bigCoor = gcodemod.read(r"C:\Users\49250\Documents\uArm-Python-SDK-2.0\code\Corrado-0_5s-60R.txt", offset) # Import gcode
...
ab = [[282.5,76], [278.5,-4.6], [280,-74]] #Calibrated printhead 2,3,4 a,b coordinates
