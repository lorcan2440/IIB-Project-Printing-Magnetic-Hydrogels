...
bigCoor = gcodemod.read(r"C:\Users\49250\Documents\uArm-Python-SDK-2.0\code\hand.txt", offset) # Import gcode
...
#set extrusion height to 1.5mm above glass slide
extrusion_height = 0
...
swift.set_position(xy_printpath[0,0]-5, xy_printpath[0,1]-10, z_gcode[0], speed=3000, wait=True)
...
swift.set_position(xy_printpath[0,0]-5, xy_printpath[0,1], z_gcode[0], speed=spp, wait=True)
swift.set_position(xy_printpath[0,0], xy_printpath[0,1], z_gcode[0], speed=spp, wait=True)
...
for n, etem in enumerate(e_gcode):
        if etem == 1: # printing
            ...
            swift.set_position(xy_printpath[n, 0], xy_printpath[n, 1], z_gcode[n],
                    speed=spp, wait=True)
        ...
        swift.flush_cmd()
        print(xy_printpath[n, 0],xy_printpath[n, 1],z_gcode[n])
time.sleep(2)
