...
# Load Gcode
spp = 50 # Printing speed 15
spnp = 1000  # Not printing speed64
Z0 = 68# starting z position 72 3ml
...
bigCoor = gcodemod.read(r"C:\Users\49250\Documents\uArm-Python-SDK-2.0\Iek\Letter_O-10x10x10-50R.txt", offset) # Import gcode
...
ab = [[282.5,76], [280.7,-2], [280,-74]] #Calibrated printhead 2,3,4 a,b coordinates
