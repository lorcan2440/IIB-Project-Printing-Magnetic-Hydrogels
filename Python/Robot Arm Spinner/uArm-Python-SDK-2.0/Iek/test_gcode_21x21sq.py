...
Z0 = 66.5  # starting z position
offset = [-3, -5, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\21x21sq-R.txt", offset) # Import gcode
