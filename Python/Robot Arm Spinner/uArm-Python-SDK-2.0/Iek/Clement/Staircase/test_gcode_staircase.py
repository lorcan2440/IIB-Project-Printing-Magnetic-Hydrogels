...
Z0 = 65.5  # starting z position 66.2 55 4.8 63.5 49.8
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\staircase_15_10_5x15x3sq-IF100.txt", offset) # Import gcode
