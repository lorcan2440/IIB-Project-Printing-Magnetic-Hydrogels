...
Z0 = 65 # starting z position 66.2 55 4.8
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\19_5x19_5x8sq-20R-1s.txt", offset) # Import gcode
