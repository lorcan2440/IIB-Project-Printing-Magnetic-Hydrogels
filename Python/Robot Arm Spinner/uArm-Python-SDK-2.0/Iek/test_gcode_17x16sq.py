...
Z0 = 50  # starting z position 66.2 57 56.2
offset = [-1, -2.5, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\20_5x20_5x5sq-70R.txt", offset) # Import gcode
...
a_gcode = 284.5  # x coord of the printhead from uArm base, mm 
