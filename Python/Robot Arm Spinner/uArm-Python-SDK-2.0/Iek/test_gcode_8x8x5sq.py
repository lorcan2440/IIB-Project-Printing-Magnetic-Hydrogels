...
Z0 = 55  # starting z position 66.2 55 4.8
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\16x16x5mmG.txt", offset) # Import gcode
...
a_gcode = 281.5  # x coord of the printhead from uArm base, mm 2 284.5 right corner
