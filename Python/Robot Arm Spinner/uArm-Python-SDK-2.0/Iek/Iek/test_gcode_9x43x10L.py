...
Z0 = 52  # starting z position 66 52
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\9x43x10mm4s-40R.txt", offset) # Import gcode
...
a_gcode = 282.5-9  # x coord of the printhead from uArm base, mm 
