...
# Setting equations
a_org = 0
n =3 # cycle number for transversal layers
m =3 # cycle number for vertical layers
L = 1 # length of the grid
w = 8 # width of the grid
...
a_cir = 254 # x coord of the printhead from uArm base, mm
b_cir = 4.2 # y coord of the printhead from uArm base, mm
xyarm_cir = transform.coordinateTransfer(x_coor_mega, y_coor_mega, a_cir, b_cir,44.5).T 
xyarm_cir_2 = transform.coordinateTransfer(x_coor_2_mega, y_coor_2_mega, a_cir, b_cir,44.5).T     
