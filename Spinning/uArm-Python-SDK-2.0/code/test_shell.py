...
# Import Arduino
ArduinoSerial = serial.Serial('COM5',2400) #COM5 is the port of syringe pump in addenbrokes
time.sleep(2)
...
# Load Gcode
spp = 27  # Printing speed
spnp = 1000  # Not printing speed 
Z0 = 67.55# starting z position

sequence=int(input('input the sequence'))
if sequence==1:
    offset = [2.5, 7 , Z0]
if sequence==2:
    offset = [2.5, 0, Z0]
...
bigCoor = gcodemod.read(r"C:\Users\49250\Documents\uArm-Python-SDK-2.0\code\box_221.8.txt", offset) # Import gcode
...
ab = [[180.5,76], [254,-4], [280,-74]] #Calibrated printhead 2,3,4 a,b coordinates ([254,-4]for addenbrokes)
