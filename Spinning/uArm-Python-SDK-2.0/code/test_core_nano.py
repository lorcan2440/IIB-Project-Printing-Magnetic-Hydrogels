...
offset = [n+(-1),m+(-0.6), Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
printhead = 3
...
ab = [[180.5,76], [282,-4.5], [280,-74]] #Calibrated printhead 2,3,4 a,b coordinates
