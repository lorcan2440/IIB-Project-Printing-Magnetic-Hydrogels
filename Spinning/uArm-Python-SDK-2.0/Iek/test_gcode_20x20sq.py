...
Z0 = 43  # starting z position 66.2 55
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\20_5x20_5x4sq-90R.txt", offset) # Import gcode
...
a_gcode = 282.5+2  # x coord of the printhead from uArm base, mm 2
b_gcode = 1.5+2 # y coord of the printhead from uArm base, mm 2
