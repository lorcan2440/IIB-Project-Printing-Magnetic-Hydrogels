...
Z0 = 65  # starting z position 65
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\9x43x10mm-60R.txt", offset) # Import gcode
...
a_gcode = 282.5-8  # x coord of the printhead from uArm base, mm 
b_gcode = 1.5+1 # y coord of the printhead from uArm base, mm
