...
# Load 
spp = 10 # Printing speed 40mona
spnp = 1000  # Not printing speed 
Z0 = 65.5 # starting z position 66.2 55 4.8 63.5 49.8 67.5
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\spiral_0001.txt", offset, 0) # Import gcode
