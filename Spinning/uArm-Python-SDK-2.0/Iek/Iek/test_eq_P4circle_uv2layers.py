...
a_cir = 280  # x coord of the printhead from uArm base, mm
b_cir = -74 # y coord of the printhead from uArm base, mm
...
ArduinoSerial.write(b'4') # Turn on printhead 3
