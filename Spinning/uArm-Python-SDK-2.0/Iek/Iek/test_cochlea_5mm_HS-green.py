...
time.sleep(1)
#62
swift.set_position(xyzarm_spi[0, 0]-8 , xyzarm_spi[0, 1] , 56.6, wait=True)
isTerminate = input('Continue? Please type any key to continue [Y/n]: ')
if isTerminate == 'n':
    sys.exit()
...
time.sleep(3)
swift.set_position(xyzarm_spi[0, 0], xyzarm_spi[0, 1], 56.6, speed = 20, wait=True)
