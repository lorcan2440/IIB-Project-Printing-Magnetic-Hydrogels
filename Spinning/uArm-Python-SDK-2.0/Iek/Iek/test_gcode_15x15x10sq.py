...
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\15x15x10sq-70R.txt", offset) # Import gcode
...
a_gcode = 282.5+1  # x coord of the printhead from uArm base, mm 2
b_gcode = 1.5+1 # y coord of the printhead from uArm base, mm 2
