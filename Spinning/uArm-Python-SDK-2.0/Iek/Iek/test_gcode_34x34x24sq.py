...
# Load Gcode
spp = 50  # Printing speed
spnp = 1000  # Not printing speed 
Z0 = 45.4  # starting z position 66.2 55 4.8 55
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0 -1 [2,1]
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\34x34x2sq-80R.txt", offset) # Import gcode
...
a_gcode = 282.5 # x coord of the printhead from uArm base, mm 2
b_gcode = 1.5 # y coord of the printhead from uArm base, mm 2left corner 1.2
# Transfrom printing coordinates to uArm coordinates, same ref point.
xyarm_gcode = transform.coordinateTransfer(x_gcode, y_gcode, a_gcode, b_gcode,44.5).T
