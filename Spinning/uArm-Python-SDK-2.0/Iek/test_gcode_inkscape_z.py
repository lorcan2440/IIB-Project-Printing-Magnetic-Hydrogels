...
Z0 = 65 # starting z position 66.2 55 4.8 63.5 49.8
num_layer = 4
layer_height = 0.5


for num_i in range(num_layer):
    offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
    start_z = 0+layer_height*num_i
    bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\flower_line_0001.txt", offset, start_z) # Import gcode
