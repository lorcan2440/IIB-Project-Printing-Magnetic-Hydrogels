...
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\gecko.txt", offset) # Import gcode
...
b_gcode = 1.5 # y coord of the printhead from uArm base,1.5 printhead 2
