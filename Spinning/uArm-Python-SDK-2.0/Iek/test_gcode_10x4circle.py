...
# Load Gcode
spp = 350  # Printing speed
spnp = 1500  # Not printing speed 
Z0 = 50  # starting z position 66.2 55 4.8 63.5 49.8
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\10x4mm-70G-0_4s.txt", offset) # Import gcode
...
a_gcode = 284.5  # x coord of the printhead from uArm base, mm 2 284.5 left corner
