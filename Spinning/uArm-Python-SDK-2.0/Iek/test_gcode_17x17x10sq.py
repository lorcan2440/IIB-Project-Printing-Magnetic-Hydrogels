...
Z0 = 66.5 # starting z position 54.5
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\19_5x19_5x8sq-60R.txt", offset) # Import gcode
x_gcode = bigCoor[:, 0] # Import x coord from gcode fil
...
a_gcode = 284.5  # x coord of the printhead from uArm base, mm 2 284.5 left corner 284.5
b_gcode = 1 # y coord of the printhead from uArm base, mm 2left corner 1.5 right corner 3.5 3
