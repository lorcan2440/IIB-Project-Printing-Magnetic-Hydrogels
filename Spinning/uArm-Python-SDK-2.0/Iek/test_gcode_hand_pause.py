...
# Function
def user_pause():
    # Pause for user (NOTE: no time limit).
...
# Load Gcode
gcodefile = r"C:\Users\Biointerface\Documents\uArmPython\examples\Iek\bear2v2.txt"
spp = 100  # Printing speed
spnp = 1000  # Not printing speed 
Z0 = 68.5  # starting z position
offset = [0, 0, Z0] # Setting as [0,0,Z0] means printing at the central point (a_gcode,b_gcde) of the stage at Z0
bigCoor = gcodemod.read(gcodefile, offset) # Import gcode
